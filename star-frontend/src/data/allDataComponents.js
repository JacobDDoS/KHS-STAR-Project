...
//This is used when adding data
//It needs these examples because it needs to know whether to have a string or date
//And it cannot rely on getting previous data and using that as a model because it may be the
    //case where all instances of some data are deleted
export const allDataComponentsExamples = [
    {
        "urltoPicture": "a;sldfhapiweunfp;iawuenbrp;ioawouhrfpi;auwhr;kaiuewhk"
    },
    {
        "name": "name",
        "runTime": "runTime",
    ...
    },
    {
        ...
        "endTime": "2022-11-26T19:14:01.090+00:00",
